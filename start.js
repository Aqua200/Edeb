...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Edeb', 'Edge', '2.0.0'] : methodCodeQR ? ['Edeb', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const mainBotAuthFile = 'EdebSession';
try {
